...
#
# Generated by Vivado on Wed May 03 22:52:54 +0700 2017
...
xv_path="E:/Xilinx/Vivado/2016.3"
...
# Script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="E:/Xilinx/Vivado/2016.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
